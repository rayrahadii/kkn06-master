        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="<?=base_url()?>assets/#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?=$this->fungsi->user_login()->nama_user?></span>
            </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?=site_url('artikel')?>"><i class="fa fa-book"></i> <span>Data Artikel</span></a></li>
        <li><a href="<?=site_url('galery')?>"><i class="fa fa-photo"></i> <span>Data Galery</span></a></li>
        <?php } ?>
